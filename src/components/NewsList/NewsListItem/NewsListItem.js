  ...
  return (
    <>
      ...
      <div className="NewsListItem">
        ...
        <p className="NewsListContent">
          "Bringing German experimental artist Hellmut Neidhardt into the fold
          under his N moniker, the N + Ehnahre ensemble's Jacob album crafts
      ...
      <div className="NewsListItem">
        ...
        <p className="NewsListContent">
          From the project's early beginnings as a builder of impenetrable walls
          to the manic, dissolving frenzy of its contemporary harsh noise
          ...
          <br />
          <br />
          GR is proud to present the newest full-length from SBDTOH, "Space:
          While Always in Childhood is Foundational Without Definition" in an
          edition of 22.
          <br />
          <br />
      ...
      <div className="NewsListItem">
        ...
        <p className="NewsListContent">
          ...
          band's first-ever tribute, a cover of My Dying Bride's classic "My
          Hope, The Destroyer." Additional violin and viola work by Andrea
          Morgan of Exulansis.
          <br />
          <br />
          <blockquote>
            <em>
              When you listen to the latest EP, ‘Daybreak’s Advent’ (2020), for
              example, you’re bearing witness to creation, not simply of a
              musical composition but of an entire reality built upon the
              foundation of sound. Starting with “Adamacy Feigned,” Maestus work
              methodically, to borrow an old Biblical stanza: “line upon line,
              precept upon precept, here a little and there a little.” With each
              well-appointed note, Maestus unfurls the cosmos in intricate
              strands of sound.
              <br />
              <br />
              ...
              Oregon all year 'round, folks!) still damp with the morning dew.
              The winds of drama stir the leaves about and, as the sun further
              makes its presence known, a certain worshipful awe overtakes the
              mood, scored by majestic voices layered together for warmth.
            </em>
          </blockquote>
          <br />
          Doomed & Stoned has{" "}
      ...
      <div className="NewsListItem">
        ...
        <p className="NewsListContent">
          "Dreamt Ascent" was recorded in autumn 2014 in Eugene, Oregon, in old
          lives, older by the second, younger their memory. σοφος & KRP
          collaborate on keyboards and synths for RWS’s first album.
      ...
      <div className="NewsListItem">
        ...
        <p className="NewsListContent">
          ...
          as J.S.H. on "I Cut Out My Tongue So I Won't Speak the Truth."
          <br />
          <br />
